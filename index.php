...
if (sizeof($_POST) > 0) {
  if (($_POST["nom"] == "") || ($_POST["prenom"] == "") || ($_POST["tel"] == "") || ($_POST["email"] == "") || ($_POST["password"] == "") || ($_POST["langue"] == "")) {
    ...
    modifyAttributes($_SESSION["id"], $_POST["prenom"], $_POST["nom"], $_POST["email"], $_POST["tel"], $_POST["password"]);
...
<head>
    ...
    <style media="screen">
      .mt-4 {
        background-color: rgb(83, 231, 177);
        padding: 2%;
        margin-bottom: 2%;
      }
      #cont {
    ...
    <div class="shadow rounded bg-white w-50 container border border-1" id="cont">
        <form method="POST" action="index.php">
            ...
            <div class="item">
              ...
              <h6>Mot de Passe</h6>
              <input name="password" type="password" name="password" id="password" placeholder="********" class="mt-1 form-control rounded"
              required>
            </div>
            <div class="title">
